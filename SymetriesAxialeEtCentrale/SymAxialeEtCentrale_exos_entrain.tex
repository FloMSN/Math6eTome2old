...
\begin{center} \includegraphics[width=7.9cm]{figures_sym} \end{center}
\end{exercice}
...
\begin{center} \includegraphics[width=8.1cm]{figures_sym2} \end{center}
\end{exercice}
...
\begin{center} \includegraphics[width=7.9cm]{figures_erreurs} \end{center}
\end{exercice}
...
Dessine un motif en t'inspirant du dessin ci‑contre sur la première moitié du calque, puis plie ton calque et complète ton dessin pour que ta figure soit symétrique par rapport à l'axe noir.
 ...
 \begin{center} \includegraphics[width=1.7cm]{papillon} \end{center}
  \end{minipage} \\
\end{exercice}
...
\begin{center} \includegraphics[width=5cm]{jeu_differences} \end{center}
\end{exercice}
...
\begin{enumerate}
 ...
 \begin{center} \includegraphics[width=6.9cm]{quadrillage_axerouge} \end{center}
...
Reproduis et colorie le minimum de cases pour que l'axe rouge soit un axe de symétrie.
 \begin{center} \includegraphics[width=8.1cm]{cases_croisees} \end{center}
\end{exercice}


\begin{exercice}[Frise]
Reproduis la figure ci‑dessous puis trace son symétrique par rapport à l'axe rouge. 
 \begin{center} \includegraphics[width=7.9cm]{frise} \end{center}
\end{exercice}
...
\begin{enumerate}
 ...
 \begin{center} \includegraphics[width=2.8cm]{pointsABd} \end{center}
...
\begin{enumerate}
 \item Reproduis une figure similaire à celle ci‑dessous : 
 \begin{center} \includegraphics[width=4.7cm]{distances} \end{center}
...
Les deux figures ci-dessous sont symétriques par rapport à une droite.
 \begin{center} \includegraphics[width=5.9cm]{sans_axe} \end{center}
 \begin{enumerate}
...
Dans chaque cas, décalque les deux figures puis trace l'axe de symétrie. (Tu expliqueras comment tu fais sans plier le calque.)
 \begin{center} \includegraphics[width=8cm]{bateaux_colores} \end{center}
\end{exercice}
...
À l'aide de la règle graduée, retrouve, sur la figure ci-dessous, toutes les paires de points qui semblent symétriques par rapport au point $N$ : 
 \begin{center} \includegraphics[width=5.8cm]{many_points} \end{center}
\end{exercice}
...
Dans chaque cas, reproduis la lettre sur du papier quadrillé et construis son symétrique par rapport au point $G$ :
 \begin{center} \includegraphics[width=7.7cm]{lettresG} \end{center}
\end{exercice}


\begin{exercice}
Sur ton cahier, reproduis la figure ci-dessous et construis les symétriques des points $P$, $R$ et $O$ par rapport au point $F$ :
 \begin{center} \includegraphics[width=5cm]{cahierFORP} \end{center}
\end{exercice}
