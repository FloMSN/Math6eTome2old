...
\begin{tabularx}{\textwidth}{X|X|X}
 \includegraphics[width=2.4cm]{equerredP} &  \includegraphics[width=2.4cm]{equerredP_perp} & \includegraphics[width=2.2cm]{symP} \\ 
...
\begin{tabularx}{\textwidth}{X|X|X}
 \includegraphics[width=3cm]{compasdP} &  \includegraphics[width=3cm]{compasdP2} & \includegraphics[width=3cm]{pointsdPS} \\ 
...
\begin{tabularx}{\textwidth}{X|X|X}
 \includegraphics[width=3cm]{regleAO} &  \includegraphics[width=3cm]{compasAO} & \includegraphics[width=3cm]{pointsAOA} \\ 
...
\begin{tabularx}{\textwidth}{X|X|X}
 \includegraphics[width=3cm]{figure_sym1} &  \includegraphics[width=3cm]{figure_sym2} & \includegraphics[width=3cm]{figure_sym3} \\ 
