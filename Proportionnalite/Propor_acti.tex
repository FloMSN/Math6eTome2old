...
Fais un tableau contenant tous les prix de 2 à 10 croissants.
 ...
 \begin{minipage}[c]{0.38\linewidth}
  \includegraphics[width=5.2cm]{prix_croissant}
  \end{minipage} \\
\end{partie}
...
\begin{enumerate}
 ...
 \end{minipage} \hfill%
 \begin{minipage}[c]{0.38\linewidth}
  \includegraphics[width=5.2cm]{prix_essence}
  \end{minipage} \\
\end{partie}
...
\vspace{0.3cm}
\begin{center} \includegraphics[width=3.1cm]{3sacs_gazon} \end{center}
 \end{minipage} \hfill%
 \begin{minipage}[c]{0.48\linewidth}
\begin{center} Terrain de 500 m\up{2} \end{center}
\vspace{0.3cm}
\begin{center} \includegraphics[width=3.1cm]{4sacs_gazon} \end{center}
  \end{minipage} \\
