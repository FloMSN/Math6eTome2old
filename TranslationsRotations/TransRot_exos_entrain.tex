...
\begin{exercice}
Recopie et complète :
\begin{center} \includegraphics[width=5.6cm]{completer_translation} \end{center}
\begin{enumerate}
...
\begin{center} \includegraphics[width=6.1cm]{voiture_vecB} \end{center}
\end{exercice}
...
\begin{colenumerate}{2}
 ...
 \end{colenumerate}
\begin{center} \includegraphics[width=5.6cm]{lettres_rotation} \end{center}
\end{exercice}
...
\begin{center} \includegraphics[width=5.4cm]{quadrillageKLJI} \end{center}
...
\begin{center} \includegraphics[width=8.1cm]{quadrillageF} \end{center}
\end{exercice}


\begin{exercice}
Reproduis la lettre $E$ dans ton cahier. Construis l'image de lettre $E$ par la rotation de centre $O$, d'angle $- 45^\circ$.
\begin{center} \includegraphics[width=8.1cm]{quadrillageE} \end{center}
\end{exercice}
